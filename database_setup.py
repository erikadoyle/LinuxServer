...
class Category(Base):
    ...
    user_id = Column(Integer, ForeignKey('user.id', onupdate="CASCADE", ondelete="SET NULL"), nullable=True)
...
class Species(Base):
    ...
    category_id = Column(Integer, ForeignKey('category.id', onupdate="CASCADE", ondelete="SET NULL"), nullable=True)
